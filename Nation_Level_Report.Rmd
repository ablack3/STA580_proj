...
test <- rbind(t11,t12,t13,t14,t15,tay)
library(knitr)
kable(test, format = "markdown", caption = "**Table 1**: The rank correlation statistics for the relationship between insurance status and having a personal doctor. The positive tau-b and gamma statistics indicate the having insurance is correlated with having a personal doctor. While the large test-statistics and p-values of virtually zero indicate that this correlation is highly statistically significant, the tau-b statistic indicates that the strength of the correlation is moderate.")
